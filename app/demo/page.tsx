...
const STEPS: { id: View; title: string; description: string }[] = [
  ...
  { id: 'adminDetail', title: 'Consultás el detalle', description: 'Toda la información del turno queda reunida para resolver cada solicitud con claridad.' },
      ...
      <header className="border-b border-[#ded9cf] bg-[#fbf8f1]/95">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-5 py-4 sm:px-8">
          <Link href="/" className="flex min-w-0 items-center gap-3 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#334e68]" aria-label="FezTime, inicio">
            ...
            <span className="truncate text-base font-semibold tracking-[-0.02em]">FezTime <span className="font-normal text-[#617083]">/ Recorrido</span></span>
          </Link>
      ...
      <section className="mx-auto w-full max-w-6xl px-5 py-10 sm:px-8 sm:py-16">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] lg:items-end">
          <div>
            ...
            <p className="mt-5 max-w-lg text-base leading-7 text-[#617083] sm:text-lg">Recorré una solicitud de turno desde la página pública hasta el panel del negocio. Es una muestra con datos de ejemplo: no genera turnos reales ni guarda cambios.</p>
        ...
        <div className="mt-12 overflow-hidden rounded-[1.5rem] border border-[#d9d4c9] bg-white shadow-[0_18px_55px_rgba(24,33,43,0.08)] sm:mt-16">
          <div className="border-b border-[#ebe7df] bg-[#faf8f3] p-5 sm:p-7">
            ...
            <div className="mt-6 grid grid-cols-5 gap-1.5" aria-label="Pasos de la experiencia">
          ...
          <div className="p-4 sm:p-8">
            <div className="mb-5 flex items-center justify-between gap-3"><p className="text-xs font-bold uppercase tracking-[0.14em] text-[#617083]">Así se vive la experiencia</p><span className="rounded-full border border-[#e5b0a7] bg-[#fff5f2] px-3 py-1 text-xs font-semibold text-[#8d3328]">Datos de ejemplo</span></div>
